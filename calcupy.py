...
print(settings.button['bg'])

class Calculator:
    def __init__(self, master):
        self.master = master
        master.title("Calcupy")
        # create screen widget
        self.screen = Text(master, state='disabled', width=30, height=3, background="gray", foreground="black")
    ...
    def createButton(self,val,write=True,width=7):
        ...
        return Button(self.master, text=val, bg="green", fg="black", command = lambda: self.click(val,write), width=width)
